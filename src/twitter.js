...
class Twitter {
	constructor(tweet) {
		this.tweet = tweet;
		this.tweet.created_at = new Date(this.tweet.created_at);
		this.tweet.sentiment = sentiment.analyze(this.tweet.text).score;
		this.tweet.domain = this.tweet.entities.urls.length > 0 ? this.tweet.entities.urls[0].expanded_url : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/^https?:\/\//, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.split("/")[0] : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/www\./, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/\/$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/#.*/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/@.*$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/&.*$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/\?.*$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%2F$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%3A$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%252F$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%253A$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%252F$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%253A$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%252F$/, "") : null;
		this.tweet.domain = this.tweet.domain ? this.tweet.domain.replace(/%253A$/, "") : null;
